...
export interface ApiClassClass extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Classes/Courses managed by teachers';
    displayName: 'Class';
    pluralName: 'classes';
    singularName: 'class';
  };
...
export interface ApiDocumentEmbeddingDocumentEmbedding
  extends Struct.CollectionTypeSchema {
  collectionName: 'document_embeddings';
  info: {
    description: 'Vector embeddings for document chunks';
    displayName: 'Document Embedding';
    pluralName: 'document-embeddings';
    singularName: 'document-embedding';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    chunkText: Schema.Attribute.Text & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::document-embedding.document-embedding'
    > &
      Schema.Attribute.Private;
...
export interface ApiDocumentDocument extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'User-uploaded documents with embeddings';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    embeddings: Schema.Attribute.Relation<
      'oneToMany',
      'api::document-embedding.document-embedding'
    >;
    extractedText: Schema.Attribute.Text;
    file: Schema.Attribute.Media<'files'> & Schema.Attribute.Required;
    fileType: Schema.Attribute.Enumeration<['pdf', 'docx', 'txt', 'other']>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiLlmConfigLlmConfig extends Struct.SingleTypeSchema {
  collectionName: 'llm_config';
  info: {
    description: 'Admin-managed LLM settings';
    displayName: 'LLM Configuration';
    pluralName: 'llm-configs';
    singularName: 'llm-config';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    claudeEnabled: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    defaultModel: Schema.Attribute.Enumeration<
      ['qwen', 'openai', 'claude', 'gemini']
    > &
      Schema.Attribute.DefaultTo<'qwen'>;
    embeddingModel: Schema.Attribute.Enumeration<['openai', 'qwen', 'local']> &
      Schema.Attribute.DefaultTo<'openai'>;
    geminiEnabled: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    openaiEnabled: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    publishedAt: Schema.Attribute.DateTime;
    qwenEnabled: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
...
export interface ApiPromptTemplatePromptTemplate
  ...
  info: {
    description: 'Admin-managed LLM prompt templates';
...
export interface ApiSubmissionSubmission extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Student homework submissions';
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::document-embedding.document-embedding': ApiDocumentEmbeddingDocumentEmbedding;
      'api::document.document': ApiDocumentDocument;
      'api::llm-config.llm-config': ApiLlmConfigLlmConfig;
