...
export const LoginPage = () => {
  ...
  const onSubmit = (data: LoginForm) => {
    ...
    // For now, redirect to teacher dashboard
        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          <div className="mt-6">
            ...
            <div className="mt-4 grid grid-cols-3 gap-3">
              <button
                onClick={() => onSubmit({ email: 'teacher@demo.com', password: 'demo123' })}
              ...
              <button
                onClick={() => onSubmit({ email: 'student@demo.com', password: 'demo123' })}
                className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-xs font-medium text-gray-500 hover:bg-gray-50"
              >
                Student
              </button>
              <button
                onClick={() => onSubmit({ email: 'admin@demo.com', password: 'demo123' })}
                className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-xs font-medium text-gray-500 hover:bg-gray-50"
              >
                Admin
              </button>
